...
const joinMostCommonPair = (mostCommonPair: string, words: Words) => {
  ...
  words.forEach((word) => {
    const symbols = word.symbols;
    const firstSymbolIndex = symbols.findIndex(
...
export const applyBPEAlgorthim = (
